defmodule MediaAssist.Accounts.User do
  use Ecto.Schema
  ...
  schema "users" do
    ...
    field :emby_user_id, :string
    field :emby_user_name, :string
    field :trakt_username, :string
  ...
  """
  def valid_password?(%MediaAssist.Accounts.User{hashed_password: hashed_password}, password)
