  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: MediaAssistWeb.Layouts]
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: MediaAssistWeb.Router,
        statics: MediaAssistWeb.static_paths()
    end
  end
